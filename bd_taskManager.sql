...
--
-- Host: localhost    Database: tasques
-- ------------------------------------------------------
...
CREATE TABLE `tasques` (
  ...
  `estat` varchar(255) DEFAULT 'incomplet',
  PRIMARY KEY (`ID`)
...
INSERT INTO `tasques` VALUES (2,'comprar','patates, pomes, carn','Completat');
...
-- Dump completed on 2024-05-08 16:16:46
